/********************************************************************************
** Form generated from reading UI file 'add_preset.ui'
**
...
#ifndef UI_ADD_PRESET_H
#define UI_ADD_PRESET_H
...
public:
    ...
    void setupUi(QDialog *AddPrinter)
    {
        if (AddPrinter->objectName().isEmpty())
            AddPrinter->setObjectName("AddPrinter");
        AddPrinter->setStyleSheet(QString::fromUtf8("\n"
"    background-color: rgb(42, 45, 46);\n"
"    color: white; \n"
"      "));
        AddPrinter->resize(376, 196);
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/img/logo-1.png"), QSize(), QIcon::Normal, QIcon::Off);
        AddPrinter->setWindowIcon(icon);
        layoutWidget = new QWidget(AddPrinter);
        ...
        power_printer = new QLabel(AddPrinter);
        ...
        input_age = new QDoubleSpinBox(AddPrinter);
        ...
        power_printer_2 = new QLabel(AddPrinter);
        ...
        input_price = new QDoubleSpinBox(AddPrinter);
        ...
        power_printer_3 = new QLabel(AddPrinter);
        ...
        input_power = new QDoubleSpinBox(AddPrinter);
        ...
        power_printer_4 = new QLabel(AddPrinter);
        ...
        input_name = new QTextEdit(AddPrinter);
        ...
        retranslateUi(AddPrinter);

        QMetaObject::connectSlotsByName(AddPrinter);
    } // setupUi

    void retranslateUi(QDialog *AddPrinter)
    {
        AddPrinter->setWindowTitle(QCoreApplication::translate("AddPrinter", "\320\224\320\276\320\261\320\260\320\262\320\273\320\265\320\275\320\270\320\265 \320\277\321\200\320\270\320\275\321\202\320\265\321\200\320\260", nullptr));
        pushButton->setText(QCoreApplication::translate("AddPrinter", "\320\241\320\276\321\205\321\200\320\260\320\275\320\270\321\202\321\214", nullptr));
        pushButton_2->setText(QCoreApplication::translate("AddPrinter", "\320\236\321\202\320\274\320\265\320\275\320\260", nullptr));
        power_printer->setText(QCoreApplication::translate("AddPrinter", "\320\241\321\200\320\276\320\272 \320\277\320\276\320\273\320\265\320\267\320\275\320\276\320\263\320\276 \320\270\321\201\320\277\320\276\320\273\321\214\320\267\320\276\320\262\320\260\320\275\320\270\321\217, \320\273\320\265\321\202", nullptr));
        power_printer_2->setText(QCoreApplication::translate("AddPrinter", "\320\241\321\202\320\276\320\270\320\274\320\276\321\201\321\202\321\214 \320\277\321\200\320\270\320\275\320\265\321\202\321\200\320\260, \321\200\321\203\320\261", nullptr));
        power_printer_3->setText(QCoreApplication::translate("AddPrinter", "\320\234\320\276\321\211\320\275\320\276\321\201\321\202\321\214 \320\277\321\200\320\270\320\275\321\202\320\265\321\200\320\260, \320\222\321\202", nullptr));
        power_printer_4->setText(QCoreApplication::translate("AddPrinter", "\320\235\320\260\320\267\320\262\320\260\320\275\320\270\320\265 \320\277\321\200\320\265\321\201\320\265\321\202\320\260", nullptr));
        input_name->setMarkdown(QString());
        input_name->setPlaceholderText(QCoreApplication::translate("AddPrinter", "\320\235\320\260\320\267\320\262\320\260\320\275\320\270\320\265 \320\277\321\200\320\270\320\275\321\202\320\265\321\200\320\260", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AddPrinter: public Ui_AddPrinter {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADD_PRESET_H
